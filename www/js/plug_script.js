...
function pushData(theUrl, theForm2Serialize, statusMonitor, successMsg, successTransfer, failurMsg, curlButton){
               ...
               $.ajax({
                   ...
                   error : function(jQXHR, error, status){
                    ...
                    $("#students_reg_form").on("submit", function(){
                        ...
                        pushData("http://tmlng.com/Mobile_app_repo/php_hub/_Bowen_Jobs/reg_processor.php", "students_reg_form", "reg_bg_process_status", "<span class='glyphicon glyphicon-time'></span>&nbsp;One moment please...", "apply_otp.html", "<i class='fa fa-times'></i>&nbsp;An error occured! Try again pls..", "students_reg_form button");
					 ...
					 $("#otp_pin_form").on("submit", function(){
                        ...
                        pushData("http://tmlng.com/Mobile_app_repo/php_hub/_Bowen_Jobs/otp_update.php", "otp_pin_form", "reg_bg_process_status", "<span class='glyphicon glyphicon-time'></span>&nbsp;One moment please...", "students_dashboard.html", "<i class='fa fa-times'></i>&nbsp;An error occured! Try again pls...", "otp_pin_form button");
		...
		$("#staffs_reg_form").on("submit", function(){
                        ...
                        pushData("http://tmlng.com/Mobile_app_repo/php_hub/_Bowen_Jobs/staffs_reg_processor.php", "staffs_reg_form", "reg_bg_process_status", "<span class='glyphicon glyphicon-time'></span>&nbsp;One moment please...", "staff_apply_otp.html", "<i class='fa fa-times'></i>&nbsp;An error occured! Try again pls...", "staffs_reg_form button");
		 ...
		 $("#staff_otp_pin_form").on("submit", function(){
                    ...
                    $("#reg_bg_process_status").css({"visibility" : "visible"}).html("<span class='glyphicon glyphicon-time'></span>&nbsp;Please wait...");
                        ...
                        pushData("http://tmlng.com/Mobile_app_repo/php_hub/_Bowen_Jobs/staff_otp_update.php", "staff_otp_pin_form", "reg_bg_process_status", "<span class='glyphicon glyphicon-time'></span>&nbsp;One moment please...", "staffs_dashboard.html", "<i class='fa fa-times'></i>&nbsp;An error occured! Try again pls...", "staff_otp_pin_form button");
	 ...
	 $("#new_job_form").on("submit", function(){
                    ...
                    $("#reg_bg_process_status").css({"visibility" : "visible"}).html("<span class='glyphicon glyphicon-time'></span>&nbsp;Please wait...");
                        ...
                        pushData("http://tmlng.com/Mobile_app_repo/php_hub/_Bowen_Jobs/job_post.php", "new_job_form", "reg_bg_process_status", "<span class='glyphicon glyphicon-time'></span>&nbsp;One moment please...", "ma_jobs.html", "<i class='fa fa-times'></i>&nbsp;An error occured! Try again pls...", "new_job_form button");
			...
			alert("hahahaha");
              ...
              function indirectUpdate(){           
                    $("#profile_update_status").html("<span class='glyphicon glyphicon-time'></span>&nbsp;Please wait...");
                        ...
                        pushData("http://tmlng.com/Mobile_app_repo/php_hub/_Bowen_Jobs/students_profile_updater.php", "students_update_form", "profile_update_status", "<span class='glyphicon glyphicon-time'></span>&nbsp;One moment please...", "students_dashboard.html", "<i class='fa fa-times'></i>&nbsp;An error occured! Try again pls...", "students_update_form button");
			  }
	 ...
	 $("#user_login_form").on("submit", function(){
                ...
                $.ajax({
                        ...
                        type : "POST",
                        cache : true,
                        url : "http://tmlng.com/Mobile_app_repo/php_hub/_Bowen_Jobs/initiate_login.php",
                        crossDomain : true,
	...
	function jobApprover(theBtn, theForm){
		...
		$.ajax({
			url : "http://tmlng.com/Mobile_app_repo/php_hub/_Bowen_Jobs/job_approver.php",
			dataType : "html",
			type : "POST",
			cache : true,
			crossDomain : true,
		...
		function jobApplicator(theBtn, theForm){
			...
			$.ajax({
			url : "http://tmlng.com/Mobile_app_repo/php_hub/_Bowen_Jobs/students_job_applicator.php",
			dataType : "html",
			type : "POST",
			cache : true,
			crossDomain : true,
